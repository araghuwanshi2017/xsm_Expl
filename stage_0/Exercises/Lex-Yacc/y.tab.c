...
#line 2 "in_postfix.y" /* yacc.c:339  */
...
union YYSTYPE
{
#line 10 "in_postfix.y" /* yacc.c:355  */
...
{
  "$end", "error", "$undefined", "LETTER", "NEWLINE", "'+'", "'*'",
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 22 "in_postfix.y" /* yacc.c:1646  */
    {printf("%s\nParsing Completed.\n",(yyval.string));exit(1);}
#line 1209 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 23 "in_postfix.y" /* yacc.c:1646  */
    {(yyval.string) = con_cat((yyvsp[-2].string),(yyvsp[0].string),(yyvsp[-1].character));}
#line 1215 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 24 "in_postfix.y" /* yacc.c:1646  */
    {(yyval.string) = con_cat((yyvsp[-2].string),(yyvsp[0].string),(yyvsp[-1].character));}
#line 1221 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 25 "in_postfix.y" /* yacc.c:1646  */
    {(yyval.string) = to_string((yyvsp[0].character));}
...
#line 27 "in_postfix.y" /* yacc.c:1906  */
